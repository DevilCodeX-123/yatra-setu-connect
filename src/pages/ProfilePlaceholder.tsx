    ...
    return (
        ...
        >
            <div className="max-w-2xl mx-auto py-20 flex flex-col items-center text-center animate-slide-up">
                ...
                <h2 className="text-3xl text-premium text-primary mb-4 ">System Upgrade in Progress</h2>
                ...
                <Button onClick={() => navigate(-1)} className="h-12 px-8 rounded-2xl text-[10px] font-black bg-primary shadow-xl shadow-primary/20">
