...
export default function BottomNav() {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-white/95 border-t border-slate-100 px-2 flex justify-around items-center z-[150] shadow-[0_-10px_40px_rgba(0,0,0,0.07)] backdrop-blur-xl md:hidden">
